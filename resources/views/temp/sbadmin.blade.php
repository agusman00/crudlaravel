            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="/perusahaan/index">{{__('Perusahaan')}}</a>
                        <a class="collapse-item active" href="/">{{__('Karyawan')}}</a>
                    </div>
                </div>
            </li>
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        ...
                                        <div class="small text-gray-500">{{__('Jae Chun · 1d')}}</div>
                                    </div>
                                </a>
    ...
    $('.delete').click( function()
    {
      ...
      var id = $(this).attr('data-id');
        swal({
          ...
          text: "{{__('Once deleted, you will not be able to recover this data')}} "+karyawanname+" {{__('file!')}}",
          icon: "warning",
          buttons: true,
          dangerMode: true,
        })
        .then((willDelete) => {
          if (willDelete) {
            window.location = "/karyawan/delete/"+id+""
